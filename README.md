# Devantia Composite Maturity Model (DCMM)

![Version](https://img.shields.io/badge/version-1.0-blue.svg)
![License](https://img.shields.io/badge/License-CC%20BY%204.0-lightgrey.svg)

## Marco Metodológico de Referencia para la Evaluación de la Madurez Tecnológica Organizacional en PYMES

El *DCMM* es un estándar abierto desarrollado por el Equipo de Arquitectura de Sistemas de [Devantia](https://devantia.com). Define una progresión acumulativa de cinco niveles de madurez tecnológica (L1-L5) para PYMEs, basada en capacidades organizativas, prerrequisitos, KPIs orientativos y evidencias objetivas de certificación.

### 📥 Descarga del Estándar Oficial
El documento oficial y normativo (PDF) está alojado y versionado permanentemente en Zenodo.
👉 *[Descargar DCMM v1.0 (PDF) desde Zenodo](https://zenodo.org/records/18816737)*
